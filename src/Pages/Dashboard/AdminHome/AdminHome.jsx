...
import { Bar, BarChart, CartesianGrid, Cell, XAxis, YAxis, PieChart, Pie, ResponsiveContainer, Tooltip, Legend } from "recharts";
    ...
    return (
        <div className="p-8 w-full">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-5 mt-5">
                ...
                <div className="stat place-items-center border rounded-lg shadow">
